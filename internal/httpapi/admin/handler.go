...
func RegisterRoutes(r chi.Router, h *Handler) {
	...
	accountsHandler := &adminaccounts.Handler{Store: deps.Store, Pool: deps.Pool, DS: deps.DS, OpenAI: deps.OpenAI, ChatHistory: deps.ChatHistory, UsageStats: deps.UsageStats}
