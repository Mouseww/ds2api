...
func TestFindToolSegmentStartDetectsXMLToolCalls(t *testing.T) {
	cases := []struct {
		...
		{"stray_closing_tool_calls_skipped", "</|DSML|tool_calls>", -1},
		{"stray_closing_tool_calls_before_real", "</|DSML|tool_calls><|DSML|tool_calls>", 19},
		{"orphaned_parameter_tag_skipped", "<|DSML|parameter name=\"x\">", -1},
